...
const fashionFrames = ["/rosie/portrait-blue.jpg", "/rosie/portrait-studio.jpg", "/rosie/portrait-stage.jpg"];

function ShowcaseFilm({ playing }: { playing: boolean }) {
  return <img className="showcase-photo fashion-film" src={sitePath("/rosie/portrait-blue.jpg")} alt="蓝色服装的时尚短片画面" data-playing={playing} />;
}
